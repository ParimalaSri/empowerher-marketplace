        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-lg mb-8">
              Have questions about our platform or need support? Reach out to us and our team will get back to you as soon as possible.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">123 EmpowerHer Street, Bangalore, Karnataka, India 560001</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">support@empowerher.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-2 bg-background rounded-full border hover:bg-muted transition-colors">
