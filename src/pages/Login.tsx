...
//   //     // API endpoint based on login type
//   //     const apiUrl = loginType === 'seller' 
...
//   //     if (response.ok) {
//   //       // Store token (modify based on authentication method)
//   //       localStorage.setItem('authToken', result.token);
  
//   //       toast({
//   //         title: 'Login successful!',
//   //         description: `Welcome back to EmpowerHer ${loginType === 'seller' ? 'Seller' : 'Customer'} Dashboard.`,
//   //       });
  
//   //       // Redirect based on user type
//   //       navigate(loginType === 'seller' ? '/seller/dashboard' : '/customer/dashboard');
//   //     } else {
...
//         localStorage.setItem('authToken', result.token);
//         localStorage.setItem('userName', result.name); // Store name dynamically
